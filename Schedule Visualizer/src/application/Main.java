		...
		try {
			...
			submit.setOnAction((EventHandler<ActionEvent>) new EventHandler<ActionEvent>() {
				public void handle(ActionEvent e) {
					...
					newRoot.add(eightAM, 0, 1);
					newRoot.add(nineAM, 0, 2);
					newRoot.add(tenAM, 0, 3);
					newRoot.add(elevenAM, 0, 4);
					newRoot.add(noon, 0, 5);
					newRoot.add(onePM, 0, 6);
					newRoot.add(twoPM, 0, 7);
					newRoot.add(threePM, 0, 8);
					newRoot.add(fourPM, 0, 9);
					newRoot.add(fivePM, 0, 10);
					newRoot.add(sixPM, 0, 11);
					newRoot.add(sevenPM, 0, 12);
					newRoot.add(eightPM, 0, 13);
					newRoot.add(ninePM, 0, 14);
					newRoot.add(tenPM, 0, 15);

					
					for(int i = 1 ; i <=16; i++) {
						for(int j = 1 ; j <= 7 ; j++) {
							newRoot.add(new Line(0, 0, 150, 0), j, i);
						} 
					}
					for(int i = 1 ; i <=8; i++) {
						for(int j = 1 ; j <= 15 ; j++) {
							newRoot.add(new Line(0, 0, 0, 50), i, j);
						} 
					}
...
//					newRoot.setHgap(15);
					...
					stage.setScene(new Scene(newRoot, 1150, 900));
					stage.show();
